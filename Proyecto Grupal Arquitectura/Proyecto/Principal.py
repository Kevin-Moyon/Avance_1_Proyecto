...
from Pag_Seg.Segmentacion import imprimir_pag_seg
from Pag_Seg.Paginacion import paginar_datos
from Pag_Seg.Paginacion import obtener_datos_sistema
def mostrar_menu():
    ...
    while True:
        ...
        print("6. Ubicación")
        print("7. Localidades")
        print("8. Paginación y Segmentación")
        print("9. Salir")
...
def sub_menu_pag_seg():
     while True:
        print("\n------ Submenú Paginación y Segmentación ------")
        print("1. Paginación")
