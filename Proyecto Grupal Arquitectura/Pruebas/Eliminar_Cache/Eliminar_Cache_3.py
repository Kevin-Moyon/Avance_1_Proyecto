...
if respuesta == 's':
    try:
        ...
        # Esperar brevemente antes de obtener información actualizada
        time.sleep(1)

        # Mostrar información de la caché L2 después de limpiar la caché del sistema
        print("Información de la caché L2 después de limpiar la caché del sistema:")
        Cache_2.obtener_informacion_cache()
